  ...
  return (
    <main className="min-h-screen bg-ink-deep text-cold-100">
      <div className="mx-auto max-w-[1400px] px-6 py-16 md:px-12 md:py-24">
        ...
        {/* Mark */}
        <section className="mb-20 grid gap-10 md:grid-cols-[1fr_1.2fr]">
          <div>
            <p className="label mb-6">01 · The mark</p>
            <h2 className="headline text-[clamp(1.6rem,3vw,2.4rem)]">A hub, and everyone it knows.</h2>
            <p className="mt-6 max-w-[44ch] text-[14px] leading-relaxed text-cold-300">
              The amber hub is the payout wallet; the cold nodes are holders. It is
              the same drawing the site animates, frozen. Keep the hub amber, keep
              the nodes cold, never recolour it to blue.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-px bg-cold-500/20">
            <div className="flex items-center justify-center bg-ink-deep p-10">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/brand/mark.svg" alt="The Social Network mark" width={220} height={220} />
            </div>
            <div className="flex items-center justify-center bg-cold-100 p-10">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/brand/mark.svg" alt="The Social Network mark on light" width={220} height={220} />
            </div>
          </div>
        </section>
