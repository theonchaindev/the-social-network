...
export const brand = {
  ...
  assets: [
    { file: "rain.png", label: "Rain on glass · plate", size: "1600 × 900" },
    { file: "network.png", label: "The network · plate", size: "1600 × 900" },
    { file: "avatar.png", label: "Profile avatar", size: "400 × 400" },
    { file: "x-banner.png", label: "X header", size: "1500 × 500" },
    { file: "og.png", label: "Link preview", size: "1200 × 630" },
    { file: "quote-card.png", label: "Quote card", size: "1080 × 1080" },
    { file: "payout-card.png", label: "Payout round card", size: "1080 × 1080" },
    { file: "wordmark.png", label: "Wordmark", size: "2400 × 620" },
    { file: "palette.png", label: "Palette sheet", size: "1600 × 420" },
  ],
  voice: [
  ...
  rules: [
    "There is no logo. Do not draw one, and do not let anyone else.",
